"""
Contains the various logging functions for the site and its components.
"""
...
def createLogger(
    ...
    logger: Logger | LoggerAdapter = getLogger(name)  # Sets the logger's name
